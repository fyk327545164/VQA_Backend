...
sys.path.append(os.path.join('vqa-maskrcnn-benchmark'))
...
class PythiaModel:
    ...
    def _init_processors(self):
        with open("./backend/model_data/pythia.yaml") as f:
            config = yaml.load(f)
        ...
        text_processor_config.params.vocab.vocab_file = "./backend/model_data/vocabulary_100k.txt"
        answer_processor_config.params.vocab_file = "./backend/model_data/answers_vqa.txt"
    ...
    def _build_pythia_model(self):
        state_dict = torch.load('./backend/model_data/pythia.pth')
        model_config = self.config.model_attributes.pythia
        model_config.model_data_dir = "./backend/"
    ...
    def _build_detection_model(self):
        ...
        cfg.merge_from_file('./backend/model_data/detectron_model.yaml')
        cfg.freeze()

        model = build_detection_model(cfg)
        checkpoint = torch.load('./backend/model_data/detectron_model.pth',
